  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <StatCard
        ...
        subtitle={stats.pendingPaymentsAmount ? `${formatCurrency(stats.pendingPaymentsAmount)} outstanding` : undefined}
        icon={PaymentIcon}
        color="warning"
      />
      <StatCard
        title="Today's Site Visits"
        value={stats.todaysSiteVisits}
        icon={VisitIcon}
        color="primary"
      />
      <StatCard
        title="Workers Available"
        value={stats.workersAvailable}
        icon={WorkerIcon}
        color="success"
      />
      <StatCard
        title="Materials Low Stock"
        value={stats.materialsLowStock}
        icon={MaterialIcon}
        color="danger"
      />
      <StatCard
